...
1. In the terminal, stop the emulator instance:
...
1. Select the `src/qemu_edu/drivers/edu_device.cc` file from
   the **OPEN EDITORS** view at the top of VS Code.

1. In the `QemuEduDevice::HandleIrq` function, between the line
...
1. In the terminal, rebuild and run the modified sample driver:
